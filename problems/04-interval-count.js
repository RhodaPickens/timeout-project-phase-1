...
function intervalCount(cb, delay, amount) {
  ...
  const intervalObj = setInterval(() => {   // nest callback inside function to add more functionality
    cb();
    amount--;                   // deprecate amount each call
    if (amount === 0) {         // stops running when amount reaches zero
